...
###
###
Polynomials should somehow return functions suitable for use in DE.jl. It should return something like f(u) = u[i1]^e1 u[i2]^e2 u[i3]^e3 etc.
...
du[7] = f1(t, u[1:3], u[4:6])
du[8] = f2(t, u[1:3], u[4:6])
du[9] = f3(t, u[1:3], u[4:6])
###
###
