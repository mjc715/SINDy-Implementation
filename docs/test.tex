...
represent \(f\) as a linear combination of elementary function of \(x\)
that contains as few terms as possible while still faithfully
representing the behavior of \(f\).

Consider first the problem of representing a series of
...
\begin{verbatim}
Status `~/Desktop/Repositories/SINDy-Implementation/Project.toml`
...
\begin{tcolorbox}[enhanced jigsaw, title={Algorithm 1 (stock)}, arc=.35mm, breakable, left=2mm, opacityback=0, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, opacitybacktitle=0.6, leftrule=.75mm, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, colback=white, toprule=.15mm]
