...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, coltitle=black, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, toptitle=1mm, title={STRidge algorithm extension to multidimensional observations (Julia
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, coltitle=black, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, toptitle=1mm, title={Compute derivatives of a trajectory (Julia implementation)}, left=2mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, bottomtitle=1mm, coltitle=black, arc=.35mm, toprule=.15mm, opacitybacktitle=0.6, leftrule=.75mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-tip-color!10!white, rightrule=.15mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, toptitle=1mm, title={Compute arbitrary polynomial functions of variables (Julia
implementation)}, left=2mm, opacityback=0]
...
\includegraphics{test_files/figure-pdf/cell-26-output-1.png}
