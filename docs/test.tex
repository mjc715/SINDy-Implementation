...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, titlerule=0mm, leftrule=.75mm, opacitybacktitle=0.6, arc=.35mm, colback=white, opacityback=0, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, coltitle=black, left=2mm, rightrule=.15mm, breakable, bottomrule=.15mm, toptitle=1mm, title={Algorithm 1 (stock)}, toprule=.15mm]
