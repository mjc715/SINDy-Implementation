...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, leftrule=.75mm, opacityback=0, breakable, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, rightrule=.15mm, left=2mm, arc=.35mm, toptitle=1mm, title={STRidge algorithm extension to multidimensional observations (Julia
implementation)}, bottomtitle=1mm, bottomrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, leftrule=.75mm, opacityback=0, breakable, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, rightrule=.15mm, left=2mm, arc=.35mm, toptitle=1mm, title={Compute derivatives of a trajectory (Julia implementation)}, bottomtitle=1mm, bottomrule=.15mm]
...
\NormalTok{  spline\_order}\OperatorTok{::}\DataTypeTok{Integer }\OperatorTok{=} \FloatTok{4}\NormalTok{, }\hspace*{\fill}\NormalTok{\circled{3}}
\NormalTok{  max\_derivative\_order }\OperatorTok{=} \FloatTok{2}\NormalTok{) }
...
\NormalTok{    for i }\OperatorTok{=} \FloatTok{0}\OperatorTok{:}\NormalTok{max\_derivative\_order]}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, coltitle=black, leftrule=.75mm, opacityback=0, breakable, colframe=quarto-callout-tip-color-frame, opacitybacktitle=0.6, titlerule=0mm, colbacktitle=quarto-callout-tip-color!10!white, colback=white, rightrule=.15mm, left=2mm, arc=.35mm, toptitle=1mm, title={Compute arbitrary polynomial functions of variables (Julia
implementation)}, bottomtitle=1mm, bottomrule=.15mm]
